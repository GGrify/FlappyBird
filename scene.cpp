    ...
    scoreRight(0)
{
    ...
    addSound(mPlayerPoint, mPlayListPoint, "qrc:/sounds/sfx_point.mp3");
}

void Scene::addFish()
{
    fish = new FishItem(QPixmap(":/images/yellowbird-upflap.png"));
    addItem(fish);
}
...
void Scene::freezeFishAndPillarsInPlace()
{
    //Freeze fish
    fish->freezeInPlace();
